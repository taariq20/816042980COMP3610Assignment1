...
st.plotly_chart(fig1, width='content'=True)
st.markdown("""
...
st.plotly_chart(fig2, width='content'=True)
st.markdown("""
...
st.plotly_chart(fig3, width='content'=True)
st.markdown("""
...
st.plotly_chart(fig4, width='content'=True)
st.markdown("""
...
st.plotly_chart(fig5, width='content'=True)
st.markdown("""
